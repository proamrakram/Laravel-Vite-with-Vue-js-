                  ...
                  <a href="javascript:void(0)" class="message-item">
                    ...
                    <div class="mail-contnet">
                      ...
                      <span class="mail-desc">
                        You can customize this template as you
                        want
                      </span>
      ...
      <ul class="navbar-nav float-right">
        ...
        <!-- <li class="nav-item search-box">
          ...
          <form
            ...
            method="GET"
            action="{{ (request()->is('product/trash')) ?    route('searching.search-trashed-products') : route('searching.search-products')}}"
          >
        ...
        <li class="nav-item dropdown">
          ...
          >
            <a class="dropdown-item" :href="`${englishCurrentURL}`">
              <i class="flag-icon flag-icon-us"></i>
              {{ english }}
            </a>
            <a class="dropdown-item" :href="`${arabicCurrentURL}`">
        ...
        <li class="nav-item dropdown">
          <a
            ...
            aria-expanded="false"
          >
            <img src="assets/images/users/me.jpg" alt="user" class="rounded-circle" width="31" />
          </a>
          <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
            ...
            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
              <div class>
                <img src="assets/images/users/me.jpg" alt="user" class="img-circle" width="60" />
              </div>
              <div class="m-l-10">
                <h4 class="m-b-0">{{ acccountname}}</h4>
                <p class="m-b-0">amroaarsi@gmail.com</p>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      lang: "en",
      arabicCurrentURL: "/?lang=ar",
      englishCurrentURL: "/?lang=en"
    };
  },
  methods: {
    changeLang(lang) {
